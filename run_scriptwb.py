...
def ant_dir(seed, log_id, gpu_id):
	...
	cmd = " python mainwb.py --env_name ant-dir \
...
def humanoid_dir(seed, log_id, gpu_id):
	...
	cmd = " python mainwb.py --env_name humanoid-dir \
...
def cheetah_vel(seed, log_id, gpu_id):
	...
	cmd = " python mainwb.py  --env_name cheetah-vel \
...
def walker_rand_params(seed, log_id, gpu_id):
	...
	cmd = " python mainwb.py --env_name walker-rand-params \
